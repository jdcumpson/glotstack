 ...
 */
export async function findGlotstackConfig(
  startDir: string = process.cwd(),
): Promise<GlotstackConfig | null> {
  ...
  while (true) {
    ...
    if (jsonExists && yamlExists) {
      console.error(
        "Both .glotstack.json and .glotstack.yaml exist, please delete one\n\n  json: ",
        jsonCandidate,
        "\n  yaml: ",
        yamlCandidate,
      )
